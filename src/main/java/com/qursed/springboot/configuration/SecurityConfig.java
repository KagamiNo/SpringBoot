package com.qursed.springboot.configuration;


import com.qursed.springboot.configuration.handler.LoginSuccessHandler;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(AuthenticationManagerBuilder auth) throws Exception {
        auth.userDetailsService(login -> (UserDetails) userService.findUserByLogin(login));
    }
